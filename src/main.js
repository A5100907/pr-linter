...
async function main() {
    ...
    const raise_failure = (core.getInput("fail-action-on-regex-failure").toLowerCase() === "true")
    const request_changes = (core.getInput("request-changes-on-regex-failure").toLowerCase() === "true")
